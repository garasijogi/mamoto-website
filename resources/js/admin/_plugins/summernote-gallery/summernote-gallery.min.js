...
var GalleryModal = /*#__PURE__*/function () {
  ...
  _createClass(GalleryModal, [{
    ...
    value: function createImages(data, page) {
      var attributes = page ? 'class="row page-content" data-page"' + page + '"' : '';
      var $content = $('<div ' + attributes + '></div>');

      var _this = this;

      for (var i = 0; i < data.length; i++) {
        var $image = $('<img class="col-md-12 py-2 mb-2 rounded-lg thumbnail" title="' + data[i].title + '"/>');
    ...
    value: function getModalTemplate() {
      ...
      var modal_html = '' + '<div class="modal summernote-gallery fade" tabindex="-1" role="dialog">' + '<div class="modal-lg modal-dialog-scrollable modal-dialog ">' + '<div class="modal-content">' + '<div class="modal-header">' + (bootsrap_version == 3 ? header_content.join('') : header_content.reverse().join('')) + '</div>' + '<div class="modal-body">' + '<div class="images-list">' + '</div>' + '</div>' + '<div class="modal-footer">' + '<span style="display: none;position: absolute;left: 10px;bottom: 10px;" class="loading" >' + '<i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>' + '</span >' + '<span class="btn-group" style="display: inline-block; margin-right: 50px;">' + '<button type="button" id="deselect-all" class="btn btn-default">[Deselect-all]</button>' + '<button type="button" id="select-all" class="btn btn-default">[select-all]</button>' + '</span >' + '<button type="button" id="close" class="btn btn-default" data-dismiss="modal">[Close]</button>' + '<button type="button" id="save" class="btn btn-primary">[Add]</button>' + '<span class="message" ></span >' + '</div>' + '</div>' + '</div>' + '</div>';
      return modal_html;
    }
  }, {
    key: "addStyleToDom",
...
var SummernoteGallery = /*#__PURE__*/function () {
  function SummernoteGallery(options) {
    ...
    this.options = $.extend({
      ...
      button_label: '<i class="fa fa-images"></i>',
