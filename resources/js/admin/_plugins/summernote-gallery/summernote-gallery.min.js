  ...
  _createClass(GalleryModal, [{
    ...
    value: function createImages(data, page) {
      ...
      for (var i = 0; i < data.length; i++) {
        var $image = $('<img class="col-md-12 py-2 rounded-lg thumbnail" title="' + data[i].title + '"/>');
