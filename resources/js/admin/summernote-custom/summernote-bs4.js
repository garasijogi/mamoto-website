...
function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function createVideoNode(url) {
      ...
      // TODO add div to iframe video embed
      // ref: https://github.com/summernote/summernote/issues/409#issuecomment-71698826
      var $container_iframe = $('<div>').addClass('embed-responsive').addClass('embed-responsive-16by9');
      var $container_embed = $('<div>').addClass('px-sm-5  mx-sm-5');

      $video.addClass('embed-responsive-item');
      $video.appendTo($container_iframe);
      $container_iframe.appendTo($container_embed);

      return $container_embed[0];
    }
  }, {
    key: "show",
    value: function show() {
