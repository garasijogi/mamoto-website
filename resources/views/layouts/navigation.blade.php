<nav id='al-navbar'
  ...
  <a href="#" class="logo"><img class="{{request()->routeIs('home') ? 'al-mamoto-white-logo' : 'al-mamoto-black-logo'}}" src="{{url('/images/mamoto_picture_logo.png')}}"
      alt=""></a>
  <ul
    ...
    <li class="d-inline portfolio-btn">
      <div class="px-3 pt-3">
        <span href="">PORTFOLIO
          <i class="fa fa-fw fa-angle-down {{request()->routeIs('home') ? 'text-white' : 'al-nav-text-goldbrown'}}">
          </i>
        </span>
      </div>
